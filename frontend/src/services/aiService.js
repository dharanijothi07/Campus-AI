...
export const aiService = {
  ...
  chat: async (query) => {
    try {
      ...
      const q = query.toLowerCase();
      let responseText = "Welcome to ACE! I can help you find suitable hackathons, check eligibility, search for paid internships, and monitor registration deadlines.";
